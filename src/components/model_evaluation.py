...
class ModelEvaluation:
    ...
    def transform_test(self,test:pd.DataFrame):
        logging.info("Transforming the test data for evaluation")
        preprocesssing_obj = load_object(file_path=self.data_transformation_artifact.transformed_object_file_path)
